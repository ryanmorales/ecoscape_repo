...
class Eservices(models.Model):
    ...
    services_name = models.CharField(max_length=50, db_index=True)
    ...
    services_slug = models.SlugField(max_length=50)
    services_href = models.CharField(max_length=50,blank=True)
